 ...
 **/
@Slf4j
public class GaoKeYongCrawlerJob extends AbstractCrawler {
    public GaoKeYongCrawlerJob(ConcurrentLinkedQueue<ProxyIp> proxyIpQueue, String pageUrl) {
        super(proxyIpQueue, pageUrl);
    }

    public GaoKeYongCrawlerJob(ConcurrentLinkedQueue<ProxyIp> proxyIpQueue, String pageUrl, int pageCount) {
    ...
    public static void main(String[] args) {
        ...
        GaoKeYongCrawlerJob gaoKeYongCrawlerJob = new GaoKeYongCrawlerJob(proxyIpQueue, "http://ip.jiangxianli.com/?page=1");

        gaoKeYongCrawlerJob.run();
    }
