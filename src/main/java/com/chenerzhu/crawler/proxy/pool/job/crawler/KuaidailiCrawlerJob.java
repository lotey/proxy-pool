 ...
 **/
@Slf4j
public class KuaidailiCrawlerJob extends AbstractCrawler {
    public KuaidailiCrawlerJob(ConcurrentLinkedQueue<ProxyIp> proxyIpQueue, String pageUrl) {
        super(proxyIpQueue, pageUrl);
    }

    public KuaidailiCrawlerJob(ConcurrentLinkedQueue<ProxyIp> proxyIpQueue, String pageUrl, int pageCount) {
